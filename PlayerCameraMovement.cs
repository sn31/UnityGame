...
public class PlayerCameraMovement : MonoBehaviour
{
    ...
    void SnapToNextPC()
    {
        transform.position = Vector3.MoveTowards(transform.position, cameraDummy.transform.position, Time.deltaTime * 20);

        if (transform.position == cameraDummy.transform.position)
        {
            //transform.position = cameraDummy.transform.position;
